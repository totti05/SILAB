...
function Header(){
	...
	$this->SetFont('Arial','B',10);
	$this->Cell(25,12,' '.$xfechar.'-'.$xturno.'-'.$xlinea,0,0,'R');
	$this->Ln(11);
	...
	$this->Cell(20,05,'      %SILICIO',0,0,C); 
	$this->Cell(25,05,'       %HIERRO',0,0,C);
	$this->Cell(25,05,'      %ALUMINIO',0,0,C); 
	$this->Cell(22,05,'      GRADO',0,0,C);
