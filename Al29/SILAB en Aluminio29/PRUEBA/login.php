...
<body id="login" class="">
		...
		<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="form-inline my-2 my-lg-0">
					<a id="btn_registro" class="btn btn-outline-success active" href="./inicio.php" role="button">Volver</a>
				</form>
			</div>
		</nav>
	</header> 
	...
	<main>
			...
			<!-- 	<script type="text/javascript">
				 ...
				 -->
		<div id="form-signin" class="container-fluid">

	      <form class= "" method="POST" action="login2.php" >
	        <h2 class="">Sistema integral de laboratorio SILAB</h2>
	        <label for="inputficha" class="sr-only">Ficha</label>
	        <input id="inputficha" class="form-control" name= "inputficha" placeholder="Ficha" required=""  type="text">
	        ...
	        <div class="checkbox mb-3 text-center">
	          <label>
	            <input class="" value="remember-me" type="checkbox">Recuerdame</label>
	        </div>
