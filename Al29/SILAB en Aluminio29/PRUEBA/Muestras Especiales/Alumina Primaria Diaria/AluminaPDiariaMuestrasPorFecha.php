	...
	<div class="container-fluid row pb-5" id="info">
			                ...
			                if (isset($conexion)) 
			                {
			                    ...
			                    if (isset($res_query)) 
			                    {
			                       ...
			                       while ($consulta = mssql_fetch_object($res_query)){
			                            ...
			                            echo '<tr>';
			                            echo '<td>'.$reportazo->cmaterial.'</td>';
			                            echo '<td>'.$reportazo->ano.'</td>';
			                            ...
			                            echo '<td><a class="link" onclick="ver_id(this.id)" id="'.$reportazo->nmuestra.'"  type="submit" href="#"">'.$reportazo->nmuestra.'</a></td>';
		...
		<script type = "text/javascript"> 
		  ...
		  function ver_id ($var){ 
			  ...
			  var filas = $('#tablaReportes tr td').id; 
