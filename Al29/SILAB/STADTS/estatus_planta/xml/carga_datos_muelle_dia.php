	...
	if ($num_filas1 > 0)
	{
		...
		if (pg_num_rows($query_m5) == 0)
		{
			...
			else
			{
				...
				echo "Se ha ingresado correctamente la información de material recepcionado";
			}
		}
		else
		{
			...
			$query_m4		=	mig_query($sq_m4, $db);
			echo "Se ha modificado correctamente la información de material recepcionado";
		}
		pg_close($db);
	}
	else
	{
		echo "No se encontró data de Material Recepcionado para el día";
	}
	ocilogoff($db_oracle);
?>