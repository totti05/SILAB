...
/*
	////// NIVEL DE SILO PRIMARIO ALUMINA DE LINEAS
	$tipo_variable		=	17;
	$sq_m_silo_1		=	"SELECT TOP 1 '$fecha_carga' AS DATE_IN, 191 AS ID_CELL, 1 AS LINEA, $turno_carga AS ID_TURNO, $tipo_variable AS tipo_campo,
							S_P_LT_VAL AS valor_variable FROM PTHL1 ORDER BY fechahora DESC ";
	$sq_m_silo_2		=	"SELECT TOP 1 '$fecha_carga' AS DATE_IN, 391 AS ID_CELL, 2 AS LINEA, $turno_carga AS ID_TURNO, $tipo_variable AS tipo_campo,
							S_P_LT_VAL AS valor_variable FROM PTHL2 ORDER BY fechahora DESC ";
	$sq_m_silo_3		=	"SELECT TOP 1 '$fecha_carga' AS DATE_IN, 591 AS ID_CELL, 3 AS LINEA, $turno_carga AS ID_TURNO, $tipo_variable AS tipo_campo,
							S_P_LT_VAL AS valor_variable FROM PTHL3 ORDER BY fechahora DESC ";
	$sq_m_silo_4		=	"SELECT TOP 1 '$fecha_carga' AS DATE_IN, 791 AS ID_CELL, 4 AS LINEA, $turno_carga AS ID_TURNO, $tipo_variable AS tipo_campo,
							S_P_LT_VAL AS valor_variable FROM PTHL4 ORDER BY fechahora DESC ";
	$sq_m_silo_5		=	"SELECT TOP 1 '$fecha_carga' AS DATE_IN, 991 AS ID_CELL, 5 AS LINEA, $turno_carga AS ID_TURNO, $tipo_variable AS tipo_campo,
							S_P_LT_VAL AS valor_variable FROM PTHL5 ORDER BY fechahora DESC ";
*/
	if ($turno_carga == 3)
	{
...
/*
	$query_m_silo_1		=	mig_query($sq_m_silo_1, $db2, 'mssql');
	$query_m_silo_2		=	mig_query($sq_m_silo_2, $db2, 'mssql');
	$query_m_silo_3		=	mig_query($sq_m_silo_3, $db2, 'mssql');
	$query_m_silo_4		=	mig_query($sq_m_silo_4, $db2, 'mssql');
	$query_m_silo_5		=	mig_query($sq_m_silo_5, $db2, 'mssql');
*/	
	mssql_close($db2);
...
/////////////EJECUCIÓN DE LOS QUERY DE DATOS DE TOLVAS BLOQUEADAS //////////////////////////////////////
	...
	$query_ansi				=	"SET ANSI_NULLS ON";
	$query_warnings			=	"SET ANSI_WARNINGS ON";
	$query_ansi				=	mssql_query($query_ansi, $db3);
	$query_warnings			=	mssql_query($query_warnings, $db3);
...
//////////////CRISOLES ASIGNADOS POR LINEAS
	if ($num_filas2 > 0)
	{
		...
		if (pg_num_rows($query_m21) == 0)
		{
			while (ocifetch($query_m22, OCI_ASSOC))
			{
				$n			=	1;
				while ($n <= 15)
				{
...
//////////////INSERT NIVEL SILO PRIMARIO LINEA 1
	if (mssql_num_rows($query_m_silo_1) > 0)
	{
		$tipo_variable		=	17;
		$sq_m21				=	"SELECT * FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '1'";
		$query_m21			=	mig_query($sq_m21, $db);
		...
		{
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_1[DATE_IN]', '$query_m_silo_1[LINEA]', '$query_m_silo_1[ID_TURNO]', '$query_m_silo_1[tipo_campo]', '$query_m_silo_1[ID_CELL]', '$query_m_silo_1[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Los datos del Nivel de Alúmina del SP Línea 1 se han cargado correctamente <br>";
		}
		else
		{
			$sq_m31			=	"DELETE FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '1'";
			...
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_1[DATE_IN]', '$query_m_silo_1[LINEA]', '$query_m_silo_1[ID_TURNO]', '$query_m_silo_1[tipo_campo]', '$query_m_silo_1[ID_CELL]', '$query_m_silo_1[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Nivel SP Alúmina Liena 1 cargado previamente, se actualizaron a últimos datos. Se ha procesado correctamente la solicitud<br>";
		}
	}
	else
	{
		echo "No se encontraron datos de Nivel de Silo Primario de Línea 1 para el día y turno solicitado <br>";
	}

//////////////INSERT NIVEL SILO PRIMARIO LINEA 2
	if (mssql_num_rows($query_m_silo_2) > 0)
	{
		$tipo_variable		=	17;
		$sq_m21				=	"SELECT * FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '2'";
		$query_m21			=	mig_query($sq_m21, $db);
		...
		{
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_2[DATE_IN]', '$query_m_silo_2[LINEA]', '$query_m_silo_2[ID_TURNO]', '$query_m_silo_2[tipo_campo]', '$query_m_silo_2[ID_CELL]', '$query_m_silo_2[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Los datos del Nivel de Alúmina del SP Línea 2 se han cargado correctamente <br>";
		}
		else
		{
			$sq_m31			=	"DELETE FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '2'";
			...
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_2[DATE_IN]', '$query_m_silo_2[LINEA]', '$query_m_silo_2[ID_TURNO]', '$query_m_silo_2[tipo_campo]', '$query_m_silo_2[ID_CELL]', '$query_m_silo_2[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Nivel SP Alúmina Linea 2 cargado previamente, se actualizaron a últimos datos. Se ha procesado correctamente la solicitud<br>";
		}
	}
	else
	{
		echo "No se encontraron datos de Nivel de Silo Primario de Línea 2 para el día y turno solicitado <br>";
	}

//////////////INSERT NIVEL SILO PRIMARIO LINEA 3
	if (mssql_num_rows($query_m_silo_3) > 0)
	{
		$tipo_variable		=	17;
		$sq_m21				=	"SELECT * FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '3'";
		$query_m21			=	mig_query($sq_m21, $db);
		...
		{
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_3[DATE_IN]', '$query_m_silo_3[LINEA]', '$query_m_silo_3[ID_TURNO]', '$query_m_silo_3[tipo_campo]', '$query_m_silo_3[ID_CELL]', '$query_m_silo_3[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Los datos del Nivel de Alúmina del SP Línea 3 se han cargado correctamente <br>";
		}
		else
		{
			$sq_m31			=	"DELETE FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '3'";
			...
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_3[DATE_IN]', '$query_m_silo_3[LINEA]', '$query_m_silo_3[ID_TURNO]', '$query_m_silo_3[tipo_campo]', '$query_m_silo_3[ID_CELL]', '$query_m_silo_3[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Nivel SP Alúmina Linea 3 cargado previamente, se actualizaron a últimos datos. Se ha procesado correctamente la solicitud<br>";
		}
	}
	else
	{
		echo "No se encontraron datos de Nivel de Silo Primario de Línea 3 para el día y turno solicitado <br>";
	}

//////////////INSERT NIVEL SILO PRIMARIO LINEA 4
	if (mssql_num_rows($query_m_silo_4) > 0)
	{
		$tipo_variable		=	17;
		$sq_m21				=	"SELECT * FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '4'";
		$query_m21			=	mig_query($sq_m21, $db);
		...
		{
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_4[DATE_IN]', '$query_m_silo_4[LINEA]', '$query_m_silo_4[ID_TURNO]', '$query_m_silo_4[tipo_campo]', '$query_m_silo_4[ID_CELL]', '$query_m_silo_4[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Los datos del Nivel de Alúmina del SP Línea 4 se han cargado correctamente <br>";
		}
		else
		{
			$sq_m31			=	"DELETE FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '4'";
			...
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_4[DATE_IN]', '$query_m_silo_4[LINEA]', '$query_m_silo_4[ID_TURNO]', '$query_m_silo_4[tipo_campo]', '$query_m_silo_4[ID_CELL]', '$query_m_silo_4[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Nivel SP Alúmina Linea 4 cargado previamente, se actualizaron a últimos datos. Se ha procesado correctamente la solicitud<br>";
		}
	}
	else
	{
		echo "No se encontraron datos de Nivel de Silo Primario de Línea 4 para el día y turno solicitado <br>";
	}

//////////////INSERT NIVEL SILO PRIMARIO LINEA 5
	if (mssql_num_rows($query_m_silo_5) > 0)
	{
		$tipo_variable		=	17;
		$sq_m21				=	"SELECT * FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '5'";
		$query_m21			=	mig_query($sq_m21, $db);
		...
		{
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_5[DATE_IN]', '$query_m_silo_5[LINEA]', '$query_m_silo_5[ID_TURNO]', '$query_m_silo_5[tipo_campo]', '$query_m_silo_5[ID_CELL]', '$query_m_silo_5[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Los datos del Nivel de Alúmina del SP Línea 5 se han cargado correctamente <br>";
		}
		else
		{
			$sq_m31			=	"DELETE FROM estatus_planta_reduccion_turno WHERE fecha = '$fecha_carga' AND turno = '$turno_carga' AND tipo_campo = '$tipo_variable' AND linea = '5'";
			...
			$sq_m13			=	"INSERT INTO estatus_planta_reduccion_turno (fecha, linea, turno, tipo_campo, num_celda, valor_variable) VALUES
								('$query_m_silo_5[DATE_IN]', '$query_m_silo_5[LINEA]', '$query_m_silo_5[ID_TURNO]', '$query_m_silo_5[tipo_campo]', '$query_m_silo_5[ID_CELL]', '$query_m_silo_5[valor_variable]');";
			$query_m13		=	mig_query($sq_m13, $db);
			echo "Nivel SP Alúmina Linea 5 cargado previamente, se actualizaron a últimos datos. Se ha procesado correctamente la solicitud<br>";
		}
	}
	else
	{
		echo "No se encontraron datos de Nivel de Silo Primario de Línea 5 para el día y turno solicitado <br>";
	}
*/
