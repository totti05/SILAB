				...
				<td>
					<div id="tab_datos_igpp" style="width:660px; height:300px;" onMouseOver="limpiar_div(6)"> 
						  <div id="tab1" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/><h4>&nbsp; &nbsp; &nbsp; OBSERVACIÓN COLADA - HORIZONTALES</h4>
									<?php
										if ($dpto_observ == 0) 
											llenar_informacion_observacion(13, $dia, $turno, $db)?><br/>
						  </div>
							  <div id="tab2" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/><h4>&nbsp; &nbsp; &nbsp; OBSERVACIÓN COLADA - VERTICALES</h4>
									<?php
										if ($dpto_observ == 0) 
											llenar_informacion_observacion(12, $dia, $turno, $db)?><br/>
						  </div>
						  <div id="tab3" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/>
									<h4>&nbsp; &nbsp; &nbsp; OBSERVACIÓN COLADA - DPM </h4>
									<?php
										if ($dpto_observ == 0) 
											llenar_informacion_observacion(14, $dia, $turno, $db)?><br/>
						  </div>
						  <div id="tab4" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/>
									<h4>&nbsp; &nbsp; &nbsp; OBSERVACIÓN COLADA - INVENTARIO Y DESPACHO </h4>
									<?php
										if ($dpto_observ == 0) 
											llenar_informacion_observacion(18, $dia, $turno, $db)?><br/>
						  </div>
				</div>
				</td>
			</tr>
...
<?php
	...
	function llenar_informacion_observacion($sub_area, $dia, $turno, $db)
	{
		...
		$sq_m1			=	"SELECT * FROM estatus_planta_observaciones WHERE fecha = '$dia' AND id_area = '3' 
		...
		?>
			...
			<div style="width:100% ">
				...
				<br/><br/>
				<input type="button" value="Procesar Linea" onClick="guarda_datos_observaciones(<?=$sub_area?>, 3)">
			</div>
		<?php
	}
?>