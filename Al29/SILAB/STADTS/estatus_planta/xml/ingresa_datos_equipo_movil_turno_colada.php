...
<?php
				...
				<td>
					<div id="tab_datos_igpp" style="width:660px; height:515px;" onMouseOver="limpiar_div(4)"> 
						  <div id="tab1" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/><h4>&nbsp; &nbsp; &nbsp; EQUIPO MÓVIL COLADA - HORIZONTALES</h4>
									<?=informacion_equipo_movil(13, $dia, $turno, $db)?><br/>
						  </div>
							  <div id="tab2" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/><h4>&nbsp; &nbsp; &nbsp; EQUIPO MÓVIL COLADA - VERTICALES</h4>
									<?=informacion_equipo_movil(12, $dia, $turno, $db)?><br/>
						  </div>
						  <div id="tab3" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/>
									<h4>&nbsp; &nbsp; &nbsp; EQUIPO MÓVIL COLADA - DPM </h4>
									<?=informacion_equipo_movil(14, $dia, $turno, $db)?><br/>
						  </div>
						  <div id="tab4" width="150" name="Datos Originales" align="center" style="font-family:Verdana, Arial, Helvetica, sans-serif ">
									<br/><br/>
									<h4>&nbsp; &nbsp; &nbsp; EQUIPO MÓVIL INVENTARIO Y DESPACHO </h4>
									<?=informacion_equipo_movil(18, $dia, $turno, $db)?><br/>
						  </div>
				</div>
				</td>
			</tr>
	...
	<script id='evaluar_javascript'>
				...
				tabbar.addTab("ventana1","Horizontales","80px");
				tabbar.addTab("ventana2","Verticales","80px");
				tabbar.addTab("ventana3","DPM","80px");
				tabbar.addTab("ventana4","INV. Y DESP.","80px");
...
<?php
	...
	function informacion_equipo_movil($sub_area, $dia, $turno, $db)	///PARA COLADA Y REDUCCIÓN
	{
		...
		if 				($sub_area == 12) 	$arreglo_datos[0][1]	=	2;
		elseif 			($sub_area == 14) 	$arreglo_datos[0][1]	=	2;
		elseif			($sub_area == 18) 	$arreglo_datos[0][1]	=	12;
		else								$arreglo_datos[0][1]	=	0;
		
		if 				($sub_area == 14) 	$arreglo_datos[0][4]	=	2;
		else 								$arreglo_datos[0][4]	=	0;
		
												$arreglo_datos[1][1]	=	0;
		$arreglo_datos[0][2]	=	0;			$arreglo_datos[1][2]	=	0;
		...
		?>
			...
			<div style="width:100%; text-align:center ">
				...
				<br/>
				<input type="button" value="Procesar Area" onClick="guarda_datos_equipo_movil_turno(<?=$sub_area?>, 3)"/>
			</div>
		<?php
	}
?>