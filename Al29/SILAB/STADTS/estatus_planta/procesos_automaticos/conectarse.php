...
//putenv("NLS_LANG=AMERICAN_AMERICA.WE8ISO8859P1");
 if (!($link=ocilogon("userctrolp", "userctrol",  "(DESCRIPTION =
     (ADDRESS_LIST =
      (ADDRESS = (PROTOCOL = TCP)(HOST = SPROD)(PORT = 1521))
     )
    (CONNECT_DATA =
      (SERVICE_NAME = SPROD)
     )
...
//////////////////////////////FUNCION CONECTARSE A POSTGRES PARA ENVIAR CORREO ////////////////////

function conectarse_postgres1() 
{ 
 if (!($link=pg_connect("host=vem-1868 port=5432 dbname=postgres user=ssp password=ssp")))
   	{ 
      echo "Error conectando a la base de datos."; 
      exit(); 
   } 
