<?php
	...
	$sq_m1							=	"SELECT 
										...
										WHERE 
										  ...
										  estatus_planta_observaciones.fecha >= current_date - 1 AND 
	...
	observaciones en sus turnos de trabajo respectivos durante la última semana de
	trabajo. 
	<br><br><br>";
...
/*	$sq_mm						= 	"INSERT INTO auxiliar_correo (id, email, asunto_correo, texto_correo) VALUES ('1', 'luis.a.martinez@venalum.com.ve',   
									'Observaciones Estatus Planta no cargadas', '$correo_final')";																// Gerente G.
	$res_mm						= 	mig_query($sq_mm, $db2);
	$sq_mm						= 	"DELETE FROM auxiliar_correo";
	$res_mm						= 	mig_query($sq_mm, $db2);

	$sq_mm						= 	"INSERT INTO auxiliar_correo (id, email, asunto_correo, texto_correo) VALUES ('1', 'pedro.marquez@venalum.com.ve', 
									'Observaciones Estatus Planta no cargadas', '$correo_final')";																// Gerencia G.
	$res_mm						= 	mig_query($sq_mm, $db2);
	$sq_mm						= 	"DELETE FROM auxiliar_correo";
	$res_mm						= 	mig_query($sq_mm, $db2);
*/
...
/*	$sq_mm						= 	"INSERT INTO auxiliar_correo (id, email, asunto_correo, texto_correo) VALUES ('1', 'angela.gonzalezc@venalum.com.ve', 
									'Observaciones Estatus Planta no cargadas', '$correo_final')";																// Gerente Reduccion
	$res_mm						= 	mig_query($sq_mm, $db2);
	$sq_mm						= 	"DELETE FROM auxiliar_correo";
	$res_mm						= 	mig_query($sq_mm, $db2);
*/
...
/*	$sq_mm						= 	"INSERT INTO auxiliar_correo (id, email, asunto_correo, texto_correo) VALUES ('1', 'miguel.villarroelf@venalum.com.ve', 
									'Observaciones Estatus Planta no cargadas', '$correo_final')";																// Gerente Suministros
	$res_mm						= 	mig_query($sq_mm, $db2);
	$sq_mm						= 	"DELETE FROM auxiliar_correo";
	$res_mm						= 	mig_query($sq_mm, $db2);
*/
...
//	$res_mm						= 	mig_query($sq_mm, $db2);
/*
	$sq_mm						= 	"INSERT INTO auxiliar_correo (id, email, asunto_correo, texto_correo) VALUES ('1', 'jesus.contreras@venalum.com.ve', 
									'Observaciones Estatus Planta no cargadas', '$correo_final')";																// Sptte instrumentacion
	$res_mm						= 	mig_query($sq_mm, $db2);
	$sq_mm						= 	"DELETE FROM auxiliar_correo";
	$res_mm						= 	mig_query($sq_mm, $db2);
*/
