		...
		<table style="width:100%" cellpadding="0" cellspacing="0">
			...
			while ($n <= 6)
			{
				...
				<tr>
					...
					<td class="TreduccionAncho2"><div style="width:100%"><?=valida_dato2($reduccion_total_dia_turno[6][$n])?></div></td>
					<td class="TreduccionAncho2UltimaColumna"><div style="width:100%"><?=valida_dato2($reduccion_total_dia_turno[9][$n])?></div></td>
				</tr>
				<?php
				$n++;
			}
			...
			<tr>
				...
				<td class="TreduccionAncho2FondoAmarillo"><div style="width:100%"><?=valida_dato2($acum_dia_reduccion[6])?></div></td>
				<td class="TreduccionAncho2FondoAmarilloUltimaColumna"><div style="width:100%"><?=valida_dato2($acum_dia_reduccion[9])?></div></td>
			</tr>
			<tr>
				...
				<td class="TreduccionAncho2FondoGris"><div style="width:100%"><?=valida_dato2($acum_sem_reduccion[6])?></div></td>
				<td class="TreduccionAncho2FondoGrisUltimaColumna"><div style="width:100%"><?=valida_dato2($acum_sem_reduccion[9])?></div></td>
			</tr>
			<tr>
				...
				<td class="TreduccionAncho2FondoAzul"><div style="width:100%"><?=valida_dato2($acum_mes_reduccion[6])?></div></td>
				<td class="TreduccionAncho2FondoAzulUltimaColumna"><div style="width:100%"><?=valida_dato2($acum_mes_reduccion[9])?></div></td>
			</tr>
		...
		<?php
			...
			?>
				<tr>
					...
					<td class="TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_4(13, 5, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$res_observ_4[$n]['num_celdas_tolv_bloq']?></div></td>
				...
				<td style="width:100%">
					<table style="width:100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(1, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">MONTACARGA</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(2, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">REMOLCADOR</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(3, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">SKYDER</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(4, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">PAYLOADER</div></td>
							<td class="TrEquipoMovilAncho2UltimaColumna"><div style="width:100%" onDblClick="ventana_detalles_2(5, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">CAMION</div></td>
						</tr>
						<tr>
							...
							<td class="TrEquipoMovilAncho2UltimaColumna"><div style="width:100%" onDblClick="ventana_detalles_2(5, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)"><?=$equipo_movil_turno[5]['estandar']?></div></td>
						</tr>
						<tr>
							...
							<td class="TrEquipoMovilAncho2UltimaColumna"><div style="width:100%" onDblClick="ventana_detalles_2(5, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)"><?=$equipo_movil_turno[5]['operativo']?></div></td>
						</tr>
					</table><br/>
				</td>
			</tr>
