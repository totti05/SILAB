...
{
	$n			=	1;
	global $reduccion_turno, $fecha_reporte, $turno_reporte, $res_observ_4, $cantidad_celdas, $total_reduccion_turno, $equipo_movil_turno, $autonomia_operativa_planta;;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
	<table style="width:100%; text-align:center	" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="silos_TrReduccionTurnoAreasAncho3">BAÑO (%) </td>
			<td class="TrReduccioTrunosAncho2UltimaColumna">Aut.Op(Dia)</td>
		</tr>
		<?php
			while ($n <= 5)
			{
