...
<?php
	...
	{
		$sq_m1							=	"SELECT * FROM estatus_planta_reduccion_turno WHERE fecha = '$dia' AND turno = '$turno' AND tipo_campo = '17' ORDER BY linea;";
				...
				<div style="width:100% ">
					<table style="width:80%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td class="encabezado_formulario_ingreso">Torre 5</td>
						</tr>
						<tr>
