...
function tabla_reduccion_turno()
{
	...
	global $reduccion_turno, $fecha_reporte, $turno_reporte, $res_observ_4, $cantidad_celdas, $total_reduccion_turno, $prod_reduc_turno, 
			$color_tabla_reduccion, $equipo_movil_turno, $autonomia_operativa_planta;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
		...
		<?php
			...
			?>
				<tr>
					...
					<td class="TrReduccioTrunosAncho2UltimaColumna"><?php  echo round($reduccion_turno[20][$n],1); ?></td>
				</tr>
			<?php
				$n++;
			}
...
{
	global $prod_reduc_turno, $materias_primas, $dias_consumo, $turno_reporte, $fecha_reporte;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
