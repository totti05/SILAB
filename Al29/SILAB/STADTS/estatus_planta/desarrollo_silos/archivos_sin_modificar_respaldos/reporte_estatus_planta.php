		...
		<table style="width:100%" cellpadding="0" cellspacing="0">
			...
			<tr style="height:175px">
				<td style="width:64%; text-align:center ">
					<div id="tabla_reduccion_1" style="height:180px; width:100%; text-align:center"><?=tabla_reduccion_turno()?></div>
				</td>
				<td style="width:36% ">
					<div id="tabla_reduccion_1" style="height:180px; width:100%; text-align:center"><?=tabla_equipo_movil_materia_prima()?></div>
				</td>
			</tr>
...
{
	$n			=	1;
	global $reduccion_turno, $fecha_reporte, $turno_reporte, $res_observ_4, $cantidad_celdas, $total_reduccion_turno, $equipo_movil_turno;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
	<table style="width:100%; text-align:center	" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="silos_TrReduccionTurnoAreasAncho2">DERRAM Fl</td>
			<td class="silos_TrReduccionTurnoAreasAncho2">DERRAM Al</td>
			<td class="silos_TrReduccionTurnoAreasAncho3">PRIM.Al (%) </td>
			<td class="silos_TrReduccionTurnoAreasAncho3">SEC.Al (%) </td>
			<td class="TrReduccioTrunosAncho2UltimaColumna">BAÑO (%) </td>
		</tr>
		<?php
			while ($n <= 5)
			{
			?>
				<tr>
					...
					<td class="silos_TrReduccionTurnoAreasAncho2"><?php if ($n == 5 ) echo $reduccion_turno[17][$n]." / ".$reduccion_turno[17][6]; else echo $reduccion_turno[17][$n];?></td>
...
{
	global $prod_reduc_turno, $color_tabla_reduccion, $materias_primas, $dias_consumo;
	?>
