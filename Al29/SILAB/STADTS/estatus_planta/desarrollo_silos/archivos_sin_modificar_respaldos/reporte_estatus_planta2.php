...
{
	$n			=	1;
	global $reduccion_turno, $fecha_reporte, $turno_reporte, $res_observ_4, $cantidad_celdas, $total_reduccion_turno, $prod_reduc_turno, $color_tabla_reduccion, $equipo_movil_turno;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
	<table style="width:100%; text-align:left	" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan="14" class="bordesLineaPrincipal">AREA REDUCCIÓN TURNO (T<?=$turno_reporte?>)</td>
		</tr>
		<tr>
			<td class="bordesLinea1">&nbsp;</td>
			...
			<td class="bordesLinea1Ancho2UltimaColumna" colspan="3">NIVEL SILOS</td>
		</tr>
		<tr>
			...
			<td style="font-size:8px" class="TrReduccioTrunosAncho2UltimaColumna">BAÑO (%) </td>
		</tr>
		<?php
			while ($n <= 5)
			{
			?>
				<tr>
					...
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?php if ($n == 5 ) echo $reduccion_turno[17][$n]." / ".$reduccion_turno[17][6]; else echo $reduccion_turno[17][$n];?></td>
					...
					<td class="TrReduccioTrunosAncho2UltimaColumna"><?php echo $reduccion_turno[19][$n]?></td>
				</tr>
			<?php
				$n++;
			}
		...
		<tr>
			...
			<td class="TrReduccioTrunosAncho2UltimaColumna"><?=$total_reduccion_turno[19]?></td>
		</tr>
	</table>
	<br>
