...
function tabla_reduccion_turno()
{
	...
	<table style="width:100%; text-align:left	" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td style="font-size:8px" class="TrReduccionTurnoAreasAncho2">TOLVA BLOQ</td>
		...
		<?php
			...
			?>
				<tr>
					...
					<td class="TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_6(13, 5, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$reduccion_turno[7][$n]?></div></td>
		...
		<tr>
			...
			<td class="TrReduccionTurnoAreasAncho2"  onDblClick='ventana_detalles_6(13, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$total_reduccion_turno[7]?></td>
