...
if ($res_prod_t1['PROD_NETA_T2'] > 0) 	$prod_reduc_turno[2]	=	$res_prod_t1['PROD_NETA_T2']; 	else	$prod_reduc_turno[2] = 0;
if ($res_prod_t1['PROD_NETA_T3'] > 0) 	$prod_reduc_turno[3]	=	$res_prod_t1['PROD_NETA_T3']; 	else	$prod_reduc_turno[3] = 0;
