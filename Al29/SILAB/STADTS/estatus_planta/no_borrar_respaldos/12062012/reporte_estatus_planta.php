...
function tabla_reduccion_turno()
{
	...
	<table style="width:40%; text-align:left	" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td style="width:25%; font-size:8px; text-align:center" class="TrOtrasAreasAncho1"><?=$prod_reduc_turno[1]?></td>
			<td style="width:25%; font-size:8px; text-align:center" class="TrReduccionTurnoAreasAncho2"><?=$prod_reduc_turno[2]?></td>
			<td style="width:25%; font-size:8px; text-align:center" class="TrReduccionTurnoAreasAncho2"><?=$prod_reduc_turno[3]?></td>
			<td style="width:25%; font-size:8px; text-align:center" class="TrReduccioTrunosAncho2UltimaColumna"><?=$prod_reduc_turno[4]?></td>
		</tr>
	</table>
	<?php
}
