		...
		<table style="width:100%" cellpadding="0" cellspacing="0">
			...
			<tr style="height:180px">
				<td style="width:50%; text-align:center ">
					<div id="tabla_reduccion_1" style="height:180px; overflow:auto; width:90%; text-align:center"><?=tabla_reduccion_turno()?></div>
				</td>
				<td style="width:50% ">
					<div id="tabla_reduccion_1" style="height:180px; overflow:auto; width:100%; text-align:center"><?=tabla_equipo_movil_materia_prima()?></div>
				</td>
			</tr>
				...
				<td style="width:100%">
					<table style="width:100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(5, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">CAMIÓN</div></td>
							<td class="TrEquipoMovilAncho2UltimaColumna"><div style="width:90%" onDblClick="ventana_detalles_2(6, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">TRACTOR&nbsp;</div></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="TrOtrasAreasAncho1_2">&nbsp;</td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(7, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">CISTERNA</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(8, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">COMPRESOR</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(9, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">MONTACARGA(R)</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(10, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">PLATAFORMA</div></td>
							<td class="TrEquipoMovilTurnoAreasAncho2"><div style="width:100%" onDblClick="ventana_detalles_2(11, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$turno_reporte?>)">EXCAVADORA</div></td>
