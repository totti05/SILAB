			...
			<div style="width:100%; text-align:center ">
				<table style="width:100%; text-align:center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_1" size="4" maxlength="8" value="<?=$res_m1['plan_alumina']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_2" size="4" maxlength="6" value="<?=$res_m1['plan_criolita']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_3" size="4" maxlength="6" value="<?=$res_m1['plan_floruro']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_4" size="4" maxlength="5" value="<?=$res_m1['plan_coque_met']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_5" size="4" maxlength="8" value="<?=$res_m1['plan_coque_pet']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_6" size="4" maxlength="7" value="<?=$res_m1['plan_alquitran']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="inventarios_7" size="4" maxlength="5" value="<?=$res_m1['plan_arrabio']?>" onKeyPress="javascript:if(event.keyCode<46 || event.keyCode>57){return false;}"></td>
					</tr>
				</table>
				<br/>
