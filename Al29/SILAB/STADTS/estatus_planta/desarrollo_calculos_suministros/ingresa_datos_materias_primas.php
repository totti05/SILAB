			...
			<div style="width:100%; text-align:center ">
				<table style="width:100%; text-align:center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_1" size="4" maxlength="5" value="0" disabled></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_2" size="4" maxlength="5" value="0" disabled></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_3" size="4" maxlength="5" value="0" disabled></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_4" size="4" maxlength="5" value="0" disabled></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_5" size="4" maxlength="5" value="0" disabled></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_6" size="4" maxlength="5" value="0" disabled></td>
						<td class="cuerpo_formulario_ingreso_1"><input type="text" id="dias_consumo_7" size="4" maxlength="5" value="0" disabled></td>
					</tr>
				</table>
