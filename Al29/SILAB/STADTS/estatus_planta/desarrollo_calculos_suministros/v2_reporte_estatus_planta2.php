<?php
include 'v2_select_reporte_estatus_planta.php';
		...
		<table style="width:100%" cellpadding="0" cellspacing="0">
			...
			<tr style="height:250px">
				<td style="width:70%; text-align:left ">
					<div id="tabla_reduccion_1" style="height:250px; overflow:auto; width:99%; text-align:left"><?=tabla_reduccion_turno()?></div>
				</td>
				<td style="width:30% ">
					<div id="tabla_reduccion_1" style="height:250; overflow:auto; width:99%; text-align:right"><?=tabla_equipo_movil_materia_prima()?></div>
				</td>
			</tr>
			<tr style="height:320px">
				<td colspan="2" style="width:100% ">
					<div id="tabla_reduccion_1" style="height:320px; overflow:auto; width:100%"><?=tabla_observaciones()?></div>
				</td>
			</tr>
		</table>
		<?php
		...
		<table style="width:100%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width:60%" align="center">
					<h5>INFORME GERENCIAL ESTATUS DE PLANTA <br>
...
function tabla_reduccion_dia()
{
	global $reduccion_diario, $reduccion_total_dia_turno, $acum_mes_reduccion, $acum_sem_reduccion, $acum_dia_reduccion, $fecha_reporte,
			...
			$titulo_reduccion_dia_c5_1, $titulo_reduccion_dia_c5_2, $fecha_reduccion_dia;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	
		list($año_red_dia, $mes_red_dia, $dia_red_dia)	=	split('-', $fecha_reduccion_dia);
		$fecha_reduccion_dia_mostrar					=	"$dia_red_dia/$mes_red_dia/$año_red_dia";
	?>
		<table style="width:100%" cellpadding="0" cellspacing="0">
			<tr>
...
function tabla_areas_turno()
{
	...
	$carbon_diario_3, $acum_sem_carbon_2, $acum_mes_carbon_2, $titulo_carbon_produc_ant4;
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="TrOtrasAreasAncho2" title="<?=$titulo_carbon_produc_ant4[0]?>"><?=valida_dato2($carbon_turno_2[0][0])?> / <?=valida_dato2($carbon_turno_2[0][1])?></td>
			<td class="TrOtrasAreasAncho2" title="<?=$titulo_carbon_produc_ant4[1]?>"><?=valida_dato2($carbon_turno_2[1][0])?> / <?=valida_dato2($carbon_turno_2[1][1])?></td>
...
{
	$n			=	1;
	global $reduccion_turno, $fecha_reporte, $turno_reporte, $res_observ_4, $cantidad_celdas, $total_reduccion_turno, $prod_reduc_turno, 
			$color_tabla_reduccion, $equipo_movil_turno, $autonomia_operativa_planta, $prom_lineal_auto_oper_linea;;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
	<table style="width:100%; text-align:left	" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan="15" class="bordesLineaPrincipal">AREA REDUCCIÓN TURNO (T<?=$turno_reporte?>)</td>
		</tr>
		<tr>
			<td class="bordesLinea1">&nbsp;</td>
		...
		<tr>
			...
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">MAS DE 1 EA </td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">DESV. > 0.15</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">TOLVA BLOQ</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">SERVIDOS</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">ASIGNADOS</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">PRINC.</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">FACILID18</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">CASC.ROJO</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">DERRAM Fl</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">DERRAM Al</td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">PRIM.Al (%) </td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">SEC.Al (%) </td>
			<td style="font-size:8px" class="niv_silos_TrReduccionTurnoAreasAncho2">BAÑO (%)</td>
			<td style="font-size:8px" class="TrReduccioTrunosAncho2UltimaColumna">Inv.Op(Dia)</td>
		</tr>
		<?php
			while ($n <= 5)
			{
			?>
				<tr>
					...
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_1(2, 5, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$reduccion_turno[3][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_1(5, 5, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$reduccion_turno[4][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_6(13, 5, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$reduccion_turno[7][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%"><?=$reduccion_turno[2][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_4(11, 5, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$reduccion_turno[6][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%; color:<?php if ($reduccion_turno[1][$n] != "") {if ($reduccion_turno[1][$n] < 6.8 && $reduccion_turno[1][$n] >= 0) echo "red";}?>"><?=valida_dato2($reduccion_turno[1][$n])?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%; color:<?php if ($reduccion_turno[5][$n] != "") {if ($reduccion_turno[5][$n] < 3.8 && $reduccion_turno[5][$n] >= 0) echo "red";}?>"><?=valida_dato2($reduccion_turno[5][$n])?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_5(1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$cantidad_celdas[1][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_5(2, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$cantidad_celdas[2][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><div style="width:100%" onDblClick='ventana_detalles_5(3, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$cantidad_celdas[3][$n]?></div></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?php if ($n == 5 ) 
																			{ ?>
																				<table style="width:100%">
																					<tr>
																						<td style="width:30%" class="niv_silos_TrReduccionTurnoAreasAncho2"><div title="Silo 900"><?=$reduccion_turno[17][$n]?></div></td>
																						<td style="width:30%" class="niv_silos_TrReduccionTurnoAreasAncho2"><div title="Silo 1000"><?=$reduccion_turno[17][6]?></div></td>
																						<td style="width:30%" class="niv_silos_TrReduccionTurnoAreasAncho2"><div title="Torre 5"><?=$reduccion_turno[30][6]?></div></td>
																					</tr>
																				</table><?php
																			}
																			else echo $reduccion_turno[17][$n];?></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?php if ($n == 5 ) echo $reduccion_turno[18][$n]." / ".$reduccion_turno[18][6]; else echo $reduccion_turno[18][$n];?></td>
					<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?php echo $reduccion_turno[19][$n]?></td>
		...
		<tr>
			...
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[3]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[4]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"  onDblClick='ventana_detalles_6(13, 1, <?=$dia?>, <?=$mes?>, <?=$año?>, <?=$n?>, <?=$turno_reporte?>)'><?=$total_reduccion_turno[7]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[2]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[6]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[1]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[5]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[8]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[9]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[10]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[17]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[18]?></td>
			<td class="niv_silos_TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[19]?></td>
...
{
	global $prod_reduc_turno, $materias_primas, $dias_consumo, $turno_reporte, $fecha_reporte, $auto_oper_suministros;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
			...
			<tr>
				<td style="width:100%">
					<table style="width:100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="bordesLinea1">&nbsp;</td>
							<td style="font-size:8px" class="bordesLinea1">ALUMINA</td>
							<td style="font-size:8px" class="bordesLinea1">CRIOLITA</td>
							<td style="font-size:8px" class="bordesLinea1">FLUORURO</td>
						...
						<tr>
							<td style="font-size:8px" class="TrOtrasAreasAncho1_2">INVENT(dias)</td>
							<td class="TrMateriaPrimaTurnoAreasAncho2"><?=$auto_oper_suministros[1]?></td>
							<td class="TrMateriaPrimaTurnoAreasAncho2" onDblClick="ventana_detalles_3(2)"><?=$auto_oper_suministros[2]?></td>
							<td class="TrMateriaPrimaTurnoAreasAncho2" onDblClick="ventana_detalles_3(3)"><?=$auto_oper_suministros[3]?></td>
							<td class="TrMateriaPrimaTurnoAreasAncho2" onDblClick="ventana_detalles_3(4)"><?=$auto_oper_suministros[4]?></td>
							<td class="TrMateriaPrimaTurnoAreasAncho2" onDblClick="ventana_detalles_3(5)"><?=$auto_oper_suministros[5]?></td>
							<td class="TrMateriaPrimaTurnoAreasAncho2" onDblClick="ventana_detalles_3(6)"><?=$auto_oper_suministros[6]?></td>
							<td class="TrMateriaPrimaAncho2UltimaColumna" onDblClick="ventana_detalles_3(7)"><?=$auto_oper_suministros[7]?></td>
						</tr>
						<tr>
							<td colspan="8" class="bordesLineaPrincipal">&nbsp;</td>
						</tr>
						<tr>
		...
		<tr>
			<td style="width:100% ">
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Observación L1</td>
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Observación L2</td>
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Observación L3</td>
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Observación L4</td>
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Observación L5</td>
			...
			<td style="width:100%; vertical-align:top ">
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style="width:18%; text-align:center" class="bordesLineaPrincipal">OBSERV. ALTO VOLTAJE</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Estación de Baño 1</td>
					...
					<tr>
						<td style="width:8%" class="TrOtrasObservAncho1">Estación de Baño 2</td>
			...
			<td style="width:100%; vertical-align:top  " >
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style="width:18%; text-align:center" class="bordesLineaPrincipal">OBSERV. SERVICIOS INDUSTRIALES</td>
					</tr>
					<tr>
