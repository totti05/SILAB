		...
		<?php
			...
			?>
				<tr>
					...
					<?php if ($n == 5 ) 
					{ ?>
						<td class="niv_silos_TrReduccionTurnoAreasAncho2"><table style="width:100%">
							<tr>
								<td style="width:30%" class="niv_silos_TrReduccionTurnoAreasAncho2"><div title="Silo 900: <?=$reduccion_turno[31][5]?> t"><?=$reduccion_turno[17][$n]?></div></td>
								<td style="width:30%" class="niv_silos_TrReduccionTurnoAreasAncho2"><div title="Silo 1000: <?=$reduccion_turno[31][6]?> t"><?=$reduccion_turno[17][6]?></div></td>
								<td style="width:30%" class="niv_silos_TrReduccionTurnoAreasAncho2"><div title="Torre 5: <?=$reduccion_turno[31][7]?> t"><?=$reduccion_turno[30][6]?></div></td>
							</tr>
						</table></td><?php
					}
					else 
					{
					?>
						<td class="niv_silos_TrReduccionTurnoAreasAncho2" title="S.Prim L<?=$n?> <?=$reduccion_turno[31][$n]?> t"><?=$reduccion_turno[17][$n];?></td>
					<?
					}
					?>
...
{
	global $prod_reduc_turno, $materias_primas, $dias_consumo, $turno_reporte, $fecha_reporte, $auto_oper_suministros, $materias_primas_1;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
