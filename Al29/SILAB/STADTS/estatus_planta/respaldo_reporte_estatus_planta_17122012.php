...
{
	$n			=	1;
	global $reduccion_turno, $fecha_reporte, $turno_reporte, $res_observ_4, $cantidad_celdas, $total_reduccion_turno, $prod_reduc_turno, $color_tabla_reduccion;
	list($dia, $mes, $año)	= split('/', $fecha_reporte);
	?>
	<table style="width:100%; text-align:center	" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td class="bordesLinea1" colspan="2">PRESIÓN AIRE (BAR)</td>
			<td class="bordesLinea1"># CELDAS</td>
			<td class="bordesLinea1"># CELDAS</td>
		...
		<tr>
			...
			<td class="TrReduccionTurnoAreasAncho2" style="font-size:8px ">TOLVA BLOQ</td>
		...
		<tr>
			...
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[3]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[4]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[7]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[2]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[6]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[1]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[5]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[8]?></td>
			<td class="TrReduccionTurnoAreasAncho2"><?=$total_reduccion_turno[9]?></td>
			<td class="TrReduccioTrunosAncho2UltimaColumna"><?=$total_reduccion_turno[10]?></td>
		</tr>
	</table>
	<br>
	<table style="width:40%; text-align:left	" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan="4" style="font-size:8px; text-align:center"  class="bordesLineaPrincipal">PRODUCCION POR TURNO</td>
		</tr>
		<tr>
				...
				<td style="width:100%">
					<table style="width:100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="TrEquipoMovilTurnoAreasAncho2">CAMIÓN</td>
			...
			<td style="width:100% ">
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style="width:25%; text-align:center" class="bordesLineaPrincipal">OBSERV. TALLER AUTOMOTRIZ</td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Observación L1</td>
						<td style="width:65%" class="TrObservAncho2UltimaColumna"><?=strtolower($observ_redu_sup_1)?></td>
						<td rowspan="5" class="TrObservAncho2UltimaColumna" style="width:25%"><?=strtolower($observ_mtto_sup_1)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Observación L2</td>
						<td style="width:65%" class="TrObservAncho2UltimaColumna"><?=strtolower($observ_redu_sup_2)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Observación L3</td>
						<td style="width:65%" class="TrObservAncho2UltimaColumna"><?=strtolower($observ_redu_sup_3)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Observación L4</td>
						<td style="width:65%" class="TrObservAncho2UltimaColumna"><?=strtolower($observ_redu_sup_4)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Observación L5</td>
						<td style="width:65%" class="TrObservAncho2UltimaColumna"><?=strtolower($observ_redu_sup_5)?></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td style="width:100%; vertical-align:top ">
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style="width:25%; text-align:center" class="bordesLineaPrincipal">OBSERV. ALTO VOLTAJE</td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Molienda</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_carb_sup_1)?></td>
						<td rowspan="5" class="TrObservAncho2UltimaColumna" style="width:25%"><?=strtolower($observ_mtto_sup_2)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Hornos</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_carb_sup_2)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Envarillado</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_carb_sup_3)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Estación de Baño 1</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_carb_sup_4)?></td>
					</tr>
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">Estación de Baño 2</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_carb_sup_5)?></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td style="width:100%; vertical-align:top  " >
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style="width:25%; text-align:center" class="bordesLineaPrincipal">OBSERV. SERVICIOS INDUSTRIALES</td>
					</tr>
					<tr>
						<td class="TrOtrasObservAncho1" style="width:10%">DPM</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_col_sup_1)?></td>
						<td rowspan="4" class="TrObservAncho2UltimaColumna" style="width:25%"><?=strtolower($observ_mtto_sup_3)?></td>
					</tr>
					<tr>
						<td class="TrOtrasObservAncho1" style="width:10%">Verticales</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_col_sup_2)?></td>
					</tr>
					<tr>
						<td class="TrOtrasObservAncho1" style="width:10%">Horizontales</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_col_sup_3)?></td>
					</tr>
					<tr>
						<td class="TrOtrasObservAncho1" style="width:10%">Inv. y Desp.</td>
						<td class="TrObservAncho2UltimaColumna" style="width:65%"><?=strtolower($observ_col_sup_4)?></td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td style="width:100%; vertical-align:top  " >
				<table style="width:100% " cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td style="width:10%" class="TrOtrasObservAncho1">SCP</td>
						<td style="width:90%" class="TrObservAncho2UltimaColumna"><?=strtolower($observ_scp_sup_1)?></td>
					</tr>
				</table>
			</td>
		</tr>
