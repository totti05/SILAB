...
function mostrar_calendario($mes,$ano){
	...
	echo "<table width=130 cellspacing=1 cellpadding=0 border=0><tr><td colspan=7 align=center class=tit>";
	echo "<table width=100% cellspacing=0 cellpadding=0 border=0><tr><td style=font-size:10pt;font-weight:bold;color:white>";
	...
	echo "<a style=color:white;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	   ...
	   echo "<td align=right style=font-size:8pt;color:white>";
...
echo '
	<br>
	<table align=center cellspacing=0 cellpadding=0 border=0 class=tform>
...
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario){
	global $raiz;
	echo '<INPUT name="'.$nombrecampo.'" size="10">
	<A HREF="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')" NAME="anchor2xx" ID="anchor2xx"><font color="#660000" size="+1">Seleccionar</font></A>
	';	
}

function escribe_formulario_fecha_novacio($nombrecampo,$nombreformulario,$f1){
	global $raiz;
	echo '<INPUT name="'.$nombrecampo.'" size="10" value="'.$f1.'">
	<A HREF="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')" NAME="anchor2xx" ID="anchor2xx"><font color="#660000" size="+1">Seleccionar</font></A>
	';	
}

function escribe_formulario_fecha_novacio_di($nombrecampo,$nombreformulario,$f1){
	global $raiz;
	echo '<INPUT name="'.$nombrecampo.'" size="10" value="'.$f1.'">
	<A HREF="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')" NAME="anchor2xx" ID="anchor2xx"><font color="#660000" size="+1"><img src="/scp/libreria/calendario/calendario.JPG" alt="Calendario" width="20" height="20" /></font></A>
	';	
}
?>
