    ...
    <nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <a id="btn_registroLogin" class="btn btn-outline-success active" href="./AguaPHielo.php" role="button">Volver</a>
        </form>
      </div>
    </nav>
  </header> 
			 ...
			 <tbody>
					...
					<?php 
			            ...
			            //
			                ...
			                if (isset($conexion)) 
			                {
			                	$query="SELECT * FROM [dbo].[V_AL20_SCP_SILAB_FORANEOS_agua_y_sedimentales] WHERE cmaterial = 'AGUA POTABLE T' AND (fechaDate >= CONVERT(DATETIME,'$fechaInicio',102) AND fechaDate <=CONVERT(DATETIME, '$fechaFin',102)) ORDER BY fechaDate";
			                    //enviar query
			                    echo $query;
...
<span id="PDF" class=""></span>
				    ...
				    for (i = 0; i < rows.length; i++) {
				        ...
				        $.ajax({ 
							...
							success: function (response) { /*una vez que el archivo recibe el request lo procesa y lo devuelve*/ 
								...
								document.location = "http://control/SCP/modules/SILAB/PRUEBA/Temp/doc.pdf" ;
								   //$("#PDF").html(response);
    ...
    //$pdf->Output("F","E:\web_planta\SCP\modules\SILAB\Doc.pdf");
