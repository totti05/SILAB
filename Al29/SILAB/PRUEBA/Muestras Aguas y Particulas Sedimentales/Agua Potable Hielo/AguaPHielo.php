...
<html>
<head>
  <title>SILAB AGUA POTABLE HIELO</title>
  ...
  <div class= "row"> 
    <div  class="container-fluid text-center col-4">
      ...
      <form class="" method="POST" action="http://Aluminio30/SILAB/PDF7.php" target="_blank"> 
        ...
        <input type="text" name="material" value="AguaPHielo" hidden="">
    ...
    <div  class="container-fluid text-center col-4">
      <form class="container-fluid text-center" method="POST" action="./AguaPHieloMuestrasPorFecha.php" target="_blank">
      <h2>SOLICITUD DE REPORTE</h2>
      <h3>Agua Potable Hielo</h3>
