...
<html>
<head>
  <title>SILAB AGUA POTABLE TERMO</title>
  ...
  <div class= "row"> 
    <div  class="container-fluid text-center col-4">
      ...
      <form class="" method="POST" action="http://Aluminio30/SILAB/PDF7.php" target="_blank"> 
        ...
        <input type="text" name="material" value="AguaPTermo" hidden="">
    ...
    <div  class="container-fluid text-center col-4">
      <form class="container-fluid text-center" method="POST" action="./AguaPTermoMuestrasPorFecha.php" target="_blank">
      <h2>SOLICITUD DE REPORTE</h2>
      <h3>Agua Potable Termo</h3>
