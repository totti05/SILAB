...
<html>
<head>
  <title>SILAB AGUA INDUSTRIAL</title>
    ...
    <nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <a id="btn_registroLogin" class="btn btn-outline-success active" href="../../AguaySedimentales.php" role="button">Volver</a>
        </form>
      </div>
    </nav>
  </header> 
  ...
  <div class= "row"> 
    <div  class="container-fluid text-center col-4">
      ...
      <form class="" method="POST" action="http://Aluminio30/SILAB/PDF7.php" target="_blank"> 
    		...
    		<input class="form-control bg-dark text-light text-center" name= "nmuestra" placeholder="Nro. de Muestra" required="" type="text">
        <label for="ano" class="sr-only">A&ntilde;o</label>
        <input type="text" name="ruta" value="AguaySedimentales" hidden="">
        <input type="text" name="material" value="AguaIndustrial" hidden="">
        <input class="form-control bg-dark text-light text-center" name= "ano" placeholder="A&ntilde;o" required="" type="text">
        <button class="btn btn-success" id="btn_registroLogin" type="submit">Solicitar Reporte</button>
      </form>
    </div>
    <div  class="container-fluid text-center col-4">
      <form class="container-fluid text-center" method="POST" action="./AguaIndustrialMuestrasPorFecha.php" target="_blank">
      <h2>SOLICITUD DE REPORTE</h2>
      <h3>Agua Industrial</h3>
