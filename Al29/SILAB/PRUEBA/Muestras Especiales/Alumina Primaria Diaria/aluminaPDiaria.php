    ...
    <nav class="navbar fixed-top navbar-expand-md navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <a id="btn_registroLogin" class="btn btn-outline-success active" href="../../MuestrasE.php" role="button">Volver</a>
        </form>
      </div>
    </nav>
  </header> 
...
<main role="main" class="container">
	<div id="form-signin" class="container-fluid text-center">
		...
		<h3>Alumina Primaria Diaria</h3>
	<form class="" accept="utf-8" method="POST" action="http://Aluminio30/SILAB/PDF7.php" > <!--http://Aluminio27/SILAB/pdf7.php-->
 		<label for="nmuestra" class="sr-only">Nro. de Muestra: </label>
		<input class="form-control" name= "nmuestra" placeholder="Nro. de Muestra" required="" type="text">
    <label for="ano" class="sr-only">A&ntilde;o</label>
    <input type="text" name="ruta" value="MuestrasE" hidden="">
    <input type="text" name="material" value="AluminaPDiaria" hidden="">
    <input class="form-control" name= "ano" placeholder="A&ntilde;o" required="" type="text">
		<button class="btn btn-success" id="btn_registroLogin" type="submit">Solicitar Reporte</button>
	</form>
</div>
<form id="form-signin" class="container-fluid text-center" method="POST" action="./AluminaPDiariaMuestrasPorFecha.php" target="_blank">
  <label for="daterange" class="sr-only">fecha</label>
    <input type="text" id="calendario" name="daterange" class="form-control"> 
	<button class="btn btn-primary" id="btn_registroLogin" type="submit">Solicitar Reportes por Rango de Fecha</button>
</form>
...
<script type="text/javascript">
      ...
      $('input[name="daterange"]').daterangepicker({
         ranges: {
        'Hoy': [moment(), moment()],
        'ultimos 15 d&iacute;as': [moment().subtract(15, 'days'), moment()]
            },
        "showDropdowns": true,
        "autoapply": true,
        ...
        "locale": {
          "format": "DD/MM/YYYY",
          "separator" : " - ",
          "customRangeLabel": "Escoger rango de fecha",
