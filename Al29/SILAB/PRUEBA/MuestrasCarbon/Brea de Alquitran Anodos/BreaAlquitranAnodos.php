...
<html>
<head>
  <title>SILAB BREA ALQUITRAN ANODOS</title>
...
<main role="main" class="container">
	<div id="form-signin" class="container-fluid text-center">
		...
		<h3>Brea de alquitran de anodos</h3>
...
<form id="form-signin" class="container-fluid text-center" method="POST" action="./BreaAlquitranAnodosPorFecha.php" target="_blank">
