...
<html>
<head>
  <title>SILAB LOTE SEMANAL MOLIENDA</title>
...
<form id="form-signin" class="container-fluid text-center" method="POST" action="./LoteSemanalMoliendaPorFecha.php" target="_blank">
