...
<html>
<head>
  <title>SILAB COQUE METALURGICO</title>
...
<form id="form-signin" class="container-fluid text-center" method="POST" action="./CoqueMetalurgicoPorFecha.php" target="_blank">
