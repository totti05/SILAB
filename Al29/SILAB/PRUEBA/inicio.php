			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active">
						<a class="nav-link" href="http://Aluminio27/SILAB/pdf7.php">Acerca de <span class="sr-only">(current)</span></a>
					</li>
	 	...
	 	<div id="login" class=" login"></div>
	 	 ...
	 	 <div id="inicio"  class= "row" >
	 	 	<div class= "col-4 offset-3" >
	 	 		 <a onclick="ver_login()" class= "thumbnail"><img src= "../imagenes/CVG.jpg"> </a> 
	 	  	</div> 
	 	 	<div class="col-3">
	 	  		<a onclick="ver_login()" class= "thumbnail" ><img src= "../imagenes/venalum_Nuevo.jpg"> </a> 
	 	  	</div>
	 	  </div>
